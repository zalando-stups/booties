...
/**
 * Just invoke the endpoint and check results. Here we use a profile with custom entries on
 * 'config/application-custom.yml' to verify resolution of properties works as expected.
 *
 * @author  jbellmann
 */
...
public class TwintipCustomProfileApplicationIT {

    private static final Logger LOG = LoggerFactory.getLogger(TwintipCustomProfileApplicationIT.class);
